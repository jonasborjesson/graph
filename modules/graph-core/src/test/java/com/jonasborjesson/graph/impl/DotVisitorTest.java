...
public class DotVisitorTest extends GraphTestBase {
    ...
    public void testPrintDefaultGraph() {
        ...
        assertThat(dot.contains("two -> four"), is(true));
        assertThat(dot.contains("four -> five"), is(true));
        assertThat(dot.contains("four -> seven"), is(true));
        assertThat(dot.contains("four -> six"), is(true));
        assertThat(dot.contains("four -> three"), is(true));
    }
